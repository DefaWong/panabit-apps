...
export function Header() {
  ...
  return (
    ...
    >
      <div
        className={`mx-4 sm:mx-6 lg:mx-8 rounded-2xl transition-all duration-300 ${
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white tracking-tight">
                Panabit <span className="gradient-text">App Store</span>
              </h1>
              <p className="text-xs text-[var(--color-text-muted)] font-mono">三方应用商店</p>
            </div>
          </div>
